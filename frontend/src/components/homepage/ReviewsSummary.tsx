    ...
    return (
        <div className="mt-2 max-w-md flex items-center justify-between bg-purple-100 rounded-2xl p-4">
            <div className="flex items-center text-yellow-400 text-2xl">
                ...
                <span className="text-xl font-semibold text-black ml-3">{averageRating.toFixed(1)}/5</span>
            </div>
            <Button className="bg-purple-500 text-white px-4 py-2 rounded-xl" text="Оцените сейчас" onClick={() => setModalOpen(true)} />
            ...
            <Modal isOpen={modalOpen} onClose={() => setModalOpen(false)}>
                ...
                />
                <Button className="mt-4 bg-purple-500 text-white px-4 py-2 rounded-xl" text="Отправить" onClick={handleSubmit} />
            </Modal>
        </div>
    );
};
