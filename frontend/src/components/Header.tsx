...
const Header = () => {
  ...
  return (
    <header className="bg-[#04092C] text-white py-4 shadow-md">
      <div className="container mx-auto flex justify-between items-center px-50 mb-5">
        ...
        <nav className="flex items-center space-x-6">
          ...
          {authContext?.user ? (
            ...
            <div className="flex space-x-4">
              ...
              <Link
                to="/login"
                className="border border-white text-white py-2 px-4 rounded-lg hover:bg-white hover:text-black transition"
              >
                Войти
              </Link>
            </div>
